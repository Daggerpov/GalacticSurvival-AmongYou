def simon_says():
    import main 
    from main import pygame, gui, width, height, mouse, buttonFont, posText, spacebg, Pcol0, Pcol1, Pcol2, Pcol3, Pcol4, Pcol5, Pcol6, Pcol7, Pcol8, pattern, instructFont, colour_names
